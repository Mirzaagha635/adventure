...
async function getProducts() {
    ...
    try {
        const response = await axios.get(`https://65680fe59927836bd97408d3.mockapi.io/products?page=${page}&limit=${limit}`);
        const data = response.data;
        db = data

        data.forEach(item => {
            const box = document.createElement('div');
            box.className = 'boxDiv col-xl-4 col-lg-4 col-md-6 col-sm-12';
            box.innerHTML = `
